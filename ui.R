                                ...
                                tabItem("instructions",
                                        fluidRow(
                                                box(
                                                        ...
                                                        h3("Population"),
                                                        h4("In this box you can set the size of the population form which you are wihdrawing a sample. It is important for correcting the estimated sample for small populations (See the Formula tab)."),
                                                        h4("The default value is 10000 individuals."),
                                                        br(),
                                                        h2("Results panel"), 
                                                        br(),
                                                        h3("Inputs"),
                                                        h4("It has for blue boxes highlighting the input values."),
                                                        br(),
                                                        h3("Sample Size"),
                                                        h4("A green box shows the estimated sample size for the input paramters."),
                                                        br(),
                                                        ...
                                                        h4("This graphic shows the effect of Margin of Error and Prevalance on Sample Size. It plots the estimate sample size for three common margin of error, 10% (black), 5% (green) and 1% (blue), and prevalences from 0% to 100%, by 10%. The estimate sample size for the your input parameters is also plotted in red."),
                                                        br(),
                                                        h2("Formula Tab"),
